      ...
      <div class="col-md-12">
        <div class="box box-solid box-success">
            <div class="box-header with-border">
              ...
              <a href="<?= base_url('Welcome/show_insert/?kategori=' . $kategori) ?>" class="btn btn-warning pull-right" <?php if($kategori == 'diskon' || $kategori == 'new') echo "style='display:none;'" ?>><i class="fa fa-plus" aria-hidden="true"></i>
 Tambahkan</a>
            </div>
            <div class="box-body">
                <div class="row">
