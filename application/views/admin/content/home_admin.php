            ...
            if($new != null){
              foreach($new as $n){
                ...
                echo "
                      ...
                      <a href='" . base_url('Welcome/show_edit?id=' . $n['id']) . "' class='btn btn-sm btn-warning' id='btn-edit' name='btn-edit'><i class='fa fa-edit' aria-hidden='true'></i></a>
                      <a href='" . base_url('Barang/hapus?id=' . $n['id']) . "' class='btn btn-sm btn-danger' id='btn-hapus' name='btn-hapus' onclick='return confirm(\"Apakah anda yakin ingin menghapus data ini?\")';><i class='fa fa-trash' aria-hidden='true'></i></a>
                    </div>
                  </div>
                </div>
                ";
              ...
              foreach($disc as $d){
                ...
                echo "
                    ...
                    <div class='card-body'>
                      ...
                      <a href='" . base_url('Welcome/show_edit?id=' . $d['id']) . "' class='btn btn-sm btn-warning' id='btn-edit' name='btn-edit'><i class='fa fa-edit' aria-hidden='true'></i></a>
                      <a href='" . base_url('Barang/hapus?id=' . $d['id']) . "' class='btn btn-sm btn-danger' id='btn-hapus' name='btn-hapus' onclick='return confirm(\"Apakah anda yakin ingin menghapus data ini?\")';><i class='fa fa-trash' aria-hidden='true'></i></a>
                    </div>
                  </div>
                </div>
                ";
