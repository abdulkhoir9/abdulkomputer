          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?= base_url('Welcome/show_login') ?>" class="btn btn-default btn-flat">Sign in</a>
                  </div>
                  <div class="pull-right">
                    <a href="<?= base_url('Welcome/show_register') ?>" class="btn btn-default btn-flat">Register</a>
                  </div>
                </li>
              </ul>
          </li>
